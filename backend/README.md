...
## Project Structure
    ...
    ├── pryal_enterprise_31851  # Django project configurations
...
1. Clone this repo and `cd pryal_enterprise_31851`
...
2. Clone this repo and `cd pryal_enterprise_31851`
